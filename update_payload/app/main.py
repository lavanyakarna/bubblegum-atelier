...
from app.routers import lookbook
...
app.include_router(insights.router, dependencies=[Depends(verify_api_key)])
app.include_router(lookbook.router, dependencies=[Depends(verify_api_key)])
